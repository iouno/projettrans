		...
		<p>
			...
			<select name="pays">
				<optgroup label=<?php echo gettext("Afrique"); ?>>
					...
					<option value="benin"><?php echo gettext("Benin");?></option>
					...
					<option value="senegal"><?php echo gettext("Senegal"); ?></option>
				...
				<optgroup label=<?php echo gettext("Amerique");?>>
					...
					<option value="haiti"><?php echo gettext("Haiti"); ?></option>
					...
					<option value="saintCristopheEtNieves"><?php echo gettext("Saint-Cristophe-et-Nieves"); ?></option>
				...
				<optgroup label=<?php echo gettext("Asie");?>>
					...
					<option value="brunei"><?php echo gettext("Brunei"); ?></option>
					...
					<option value="israel"><?php echo gettext("Israel"); ?></option>
					...
					<option value="nepal"><?php echo gettext("Nepal"); ?></option>
					...
					<option value="taiwan"><?php echo gettext("Taiwan"); ?></option>
					...
					<option value="turkmenistan"><?php echo gettext("Turkmenistan"); ?></option>
					<option value="turquie"><?php echo gettext("Turquie"); ?></option>
					<option value="vietNam"><?php echo gettext("Viet Nam"); ?></option>
